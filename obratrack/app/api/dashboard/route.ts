  ...
  try {
    ...
    return NextResponse.json({
      ...
      kpi: {
        ...
        totalContrato, totalExec, totalAditivos,
        margem: totalContrato - totalExec,
        notaMedia,
        criterios: {
          qualidade: avgCrit('qualidade'),
          prazo: avgCrit('prazo'),
          custo: avgCrit('custo'),
          limpeza: avgCrit('limpeza'),
          seguranca: avgCrit('seguranca'),
          gestao: avgCrit('gestao'),
        },
      }
    });
